                            ...
                            <div class="row product-list-row">
                              ...
                              <div class="col col-sm-8 col-lg-8">
                                <div class="product-info">
                                  <h3 class="name"><a href="{{ route('product.detail',['slug'=>$product->p_slug,'id'=>$product->id]) }}">{{ $product->p_name }}</a></h3>
                                  <div class="rating rateit-small"></div>
                                  <div class="product-price"> <span class="price">{{ number_format($product->p_price) }}</span> <span class="price-before-discount"></span> </div>
                                  <!-- /.product-price -->
