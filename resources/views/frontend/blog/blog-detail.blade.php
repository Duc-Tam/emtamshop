      ...
      <div class="container">
         <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
               ...
               <li class='active'>{{ $blogs->b_name }}</li>
            </ul>
         </div>
         <!-- /.breadcrumb-inner -->
      </div>
          ...
          <div class="blog-page">
             <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="blog-post wow fadeInUp">
                   <img class="img-responsive" src="{{ $blogs->b_image }}" alt="">
                   <h1>{{ $blogs->b_name }}</h1>
                   <span class="author">{{ $blogs->b_author }}</span>
                   <span class="review">7 Comments</span>
                   <span class="date-time">{{ ($blogs->created_at)->format('d/m/Y') }}</span>
                   <p>{!! $blogs->b_content !!}</p>
                ...
                <div class="blog-post-author-details wow fadeInUp">
                   <div class="row">
                      <div class="col-md-2">
                         <img src="{{ asset('frontend/assets/images/avatar.jpg') }}" alt="Responsive image" class="img-circle img-responsive">
                      </div>
                      <div class="col-md-10">
                         <h4>Đức Tâm</h4>
                ...
                <div class="sidebar-module-container">
                   ...
                   <div class="sidebar-widget outer-bottom-xs wow fadeInUp">
                      ...
                      <ul class="nav nav-tabs">
                         <li class="active"><a href="#popular" data-toggle="tab">Tin liên quan</a></li>
